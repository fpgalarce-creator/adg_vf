  ...
  return (
    <section id="inicio" className="relative overflow-hidden">
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(18,18,18,0.62)_0%,rgba(18,18,18,0.5)_45%,rgba(18,18,18,0.38)_100%)]" />
      </div>

      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-28 sm:pb-32 lg:pt-28 lg:pb-36">
        <div className="flex justify-center items-center min-h-[460px] sm:min-h-[520px]">
          <div className="max-w-[700px] mx-auto text-center">
            ...
            <ScrollAnimation delay={120}>
              <h1
                className="font-bold text-4xl sm:text-5xl lg:text-6xl xl:text-7xl text-white leading-[1.03] mb-6 text-balance drop-shadow-[0_4px_20px_rgba(0,0,0,0.45)]"
                style={{ fontFamily: "'Playfair Display', serif" }}
              >
              Sabores auténticos,
              <span className="block text-[#D4AF37] mt-2">calidad que se nota</span>
              </h1>
            </ScrollAnimation>

            <ScrollAnimation delay={220}>
              <p className="text-[rgba(255,255,255,0.9)] text-lg sm:text-xl max-w-[640px] mx-auto mb-9 leading-relaxed">
            ...
            <ScrollAnimation delay={320}>
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-4 sm:gap-5 max-w-[520px] mx-auto">
